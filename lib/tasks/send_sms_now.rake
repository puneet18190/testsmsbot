  ...
  @client.each do |c|
    begin
      ...
      t2=Time.zone.local(year,month,date,hour,min)
        ...
        if c.results.blank?
          message = "Hey #{c.first_name}, I'm #BeltBot, the Black Belt SMS bot. I'm programmed to help you make your monthly income go up, and get you help when you need it. First, let's get a baseline. What was your income over the 12 months?"
